...
(:init 
    (black x0 y1)(black x1 y1)(black x1 y3)(black x1 y4)(black x3 y1)(black x3 y3)
   ...
   (:goal (and 
        (lit x0 y0) (lit x0 y2) (lit x0 y3) (lit x0 y4) 
        (lit x1 y0) (lit x1 y2) 
        ...
        (surrounded x1 y1 n1) (surrounded x1 y3 n2) (surrounded x3 y1 n2) (surrounded x3 y3 n2)
        ))
    )